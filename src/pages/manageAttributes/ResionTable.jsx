...
import EditResion from './EditResion';
function ResionTable() {
                                        ...
                                        <div className="modal-dialog" role="document">
                                            <div className="modal-content">
                                                <div className="modal-header">
                                                    <span className='add-reporting'>Edit Resion</span>
                                                ...
                                                <div className='space-one'>
                                                    <EditResion onClose={handleCloseModal} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
