          ...
          <div className="row  space mt-4">
            ...
            <div className="col text-end ">
              ...
              <button type="button" className=" import-button  me-2">
                <img src="images/import.png" alt="Logo " className="logo-1" />Import
              </button>

              <button type="button" className=" bcolor">
                <img src="images/re-down.png" alt="Logo " className="logo-1" />Sample Download
              </button>
                    ...
                    <div className="modal-dialog" role="document">
                      <div className="modal-content">
                        <div className="modal-header">
                          <span className='add-reporting'>Add Role</span>
