...
const EditReporting = () => {
    return (
        ...
        <div> <form className="center-form">
        <div className="row space-lable">
            <div className="col">
                <label htmlFor="roleInput"><span className='text-Role'>Role Name</span></label>
            ...
            <div className="col">
                <label htmlFor="roleInput"><span className='text-Role'>Reporting To</span></label>
                <select class="form-select" aria-label="Default select example">
                    <option selected>Select</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
